...
# ---- Fig A: Confounder Ablation FP Rates (Excluding r_overconfident) ----
names, rates, errs = [], [], []
...
# ---- Fig B: Combined Synthetic Null + Scrambled Tail ----
peaks_all = [
...
# Inset plot placed at right-side middle [x0, y0, width, height]
